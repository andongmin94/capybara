...
# 적금 url
# http://finlife.fss.or.kr/finlifeapi/savingProductsSearch.xml?auth=REMOVED_SECRET&topFinGrpNo=020000&pageNo=1
...
def save_deposit_products(request):
    # 예금 url
    url = f'http://finlife.fss.or.kr/finlifeapi/depositProductsSearch.json?auth=REMOVED_SECRET&topFinGrpNo=020000&pageNo=1'
